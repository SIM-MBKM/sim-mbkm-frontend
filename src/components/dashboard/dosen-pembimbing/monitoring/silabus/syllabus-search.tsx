...
export function SyllabusSearch({ searchQuery, onSearchChange }: SyllabusSearchProps) {
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2 flex-row justify-end w-full">
              <Button onClick={handleSearch} className="bg-gradient-to-br from-green-600/90 to-green-700 text-white">
                Search
              </Button>
