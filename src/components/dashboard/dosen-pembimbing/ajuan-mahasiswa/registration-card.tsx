          ...
          <div className="p-4 md:p-6">
            <div className="flex flex-col md:flex-row gap-4 md:items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center gap-2">
                    ...
                    <Badge variant="outline" className={getStatusColor(registration.academic_advisor_validation)}>
              ...
              <div className="flex items-center gap-2 self-end md:self-auto">
                {registration.academic_advisor_validation === "PENDING" && (
                  <>
                    <Button
                      variant="outline"
                      size="sm"
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-3">
                              ...
                              <div className="p-3 rounded-lg border bg-background/50">
                                ...
                                <p className="font-medium">{registration.academic_advisor_validation}</p>
                              </div>
                              <div className="p-3 rounded-lg border bg-background/50">
