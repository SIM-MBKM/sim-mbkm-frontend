      ...
      <Card className={`border-l-4 ${borderColor} hover:shadow-md transition-all duration-200`}>
        <CardContent className="p-4">
          <div className="flex items-start gap-3">
            <div className={`p-2 rounded-full ${typeColor} flex-shrink-0`}>{icon}</div>
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${typeBgColor} ${typeTextColor} capitalize`}
                  >
                    {notification.type}
                  </span>
                </div>
              ...
              <div className="text-sm font-medium text-gray-600 mb-1">Dari: {notification.sender_name}</div>
      ...
      <div className="py-6 mt-15">
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Semua notifikasi yang masuk untuk Anda</CardDescription>
          </CardHeader>
        </Card>
        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            Array(5)
              .fill(0)
              .map((_, index) => <div key={index} className="h-24 bg-gray-100 animate-pulse rounded-lg"></div>)
